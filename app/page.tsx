...
<section id="tenants" className="max-w-7xl mx-auto px-6 py-20">
  ...
  <div className="max-w-2xl mx-auto bg-white rounded-3xl p-8 md:p-10">
    {/* Bullet List */}
    ...
    <div className="bg-[#E8F5E9] p-8 rounded-3xl text-center">
      ...
      <p className="text-[3.00rem] sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#A8D5BA] my-3 leading-none">
        $376,920
      </p>
